...
//make tetromino move every second
...
//move tetromino left, unless it is at edge or there is a blockage
function moveLeft() {
  undraw()
...
//move tetromino right, unless it is at edge or there is a blockage
...
function displayShape() {
  //remove trace of tetromino from grid
...
const squaresRemoved = sqaures.splice(i,width)
  sqaures = squaresRemoved.concat(sqaures)
